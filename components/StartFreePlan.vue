<template lang="">
    <section class="   max-w-7xlBig z-[4] relative py-20 text-[#212121] mx-auto px-4 xl:px-8">
       ...
       <div class=" mx-auto relative z-[4] grid grid-cols-1 md:grid-cols-3 gap-6 mt-14">
   
   <div class="bg-white rounded-3xl py-1 shadow-lg overflow-hidden">
       
       <div class="relative h-72 w-[96%] mx-auto mt-[5px] rounded-3xl bg-cover bg-center" style="background-image: url('https://img.freepik.com/premium-photo/3d-rendering-realistic-composition-flying-spheres-tori-tubes-cones-crystals-motion-beautiful-abstraction-background-minimalism-3d-illustration-3d-rendering_158469-9037.jpg?w=826');">
           <div class="absolute inset-0 bg-black bg-opacity-20 flex rounded-3xl flex-col  text-white">
               <p class="text-[1.5rem] ml-[30px] mt-[30px]"># 1</p>
               <h2 class="text-[2.5rem] font-bold tracking-wider ml-[30px]">Basic</h2>
           </div>
       </div>
...
<section class="w-full mx-auto relative overflow-hidden rounded-xl md:rounded-3xl mt-20">

<div class="absolute inset-0 bg-cover bg-center"
    style="background-image: url('https://img.freepik.com/free-vector/girl-driving-car-white-background_1308-103649.jpg?t=st=1733086290~exp=1733089890~hmac=dab84b4e862b86d436ba61a178290c75858b693b23442edcbb4ce8e9c660d32b&w=826');">
    
    
    <div class="absolute inset-0 bg-gradient-to-r from-[#3A0CA3] to-[#3A0CA380]/10 opacity-100"></div>
</div>
            ...
            <div v-for="card in visibleCards" :key="card.title" 
              ...
              <div class="items-center mb-4">
                <div class="bg-[#A988F5] text-white flex items-center justify-center rounded-full size-[46px]">
                  <svg class="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32">
                    <path fill="currentColor" :d="card.icon" />
                  </svg>
                </div>
                <h2 class="text-3xl mt-3 font-semibold leading-none text-[#3E2CA3]">{{ card.title }}</h2>
              </div>
              
              <p class="text-black mb-6 text-[12px] sm:text-sm text-[16px]">{{ card.description }}</p>
              
              <div class="flex justify-end cursor-pointer">
                <svg class="text-[#3E2CA3] size-8" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
