<template lang="">
    <section class="max-w-7xl py-20 text-[#212121] mx-auto px-4">
       ...
       <div class=" mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
   
   <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
       
       <div class="relative h-56 w-[96%] mx-auto mt-[5px] rounded-2xl bg-cover bg-center" style="background-image: url('https://plus.unsplash.com/premium_photo-1669749358726-73d0d9da55e9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGslMjAlMjBsZXR0ZXIlMjBXYWxscGFwZXJ8ZW58MHx8MHx8fDA%3D');">
           <div class="absolute inset-0 bg-black bg-opacity-20 flex rounded-2xl flex-col  text-white">
       ...
       <div class="p-6">
           ...
           <div class="text-xl font-bold mb-4 mt-[30px] font-light border-b-2 pb-[10px]">$ <span class="text-[3rem] pt-[10px] font-bold "> 1</span> per year</div>
           <p class="font-medium">What's Include</p>
           
           <ul class="space-y-2 mt-[10px]">
           ...
           <button class="w-[100%] py-[14px] text-center rounded-full bg-[#ECECEC] mt-[20px]">CHOOSE PLAN</button>
       </div>
   </div>
   ...
   <div class="bg-white rounded-lg shadow-lg overflow-hidden">
       ...
       <div class="relative h-56 w-[96%] mx-auto mt-[5px] rounded-2xl bg-cover bg-center" style="background-image: url('https://plus.unsplash.com/premium_photo-1669749358726-73d0d9da55e9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGslMjAlMjBsZXR0ZXIlMjBXYWxscGFwZXJ8ZW58MHx8MHx8fDA%3D');">
           <div class="absolute inset-0 bg-black bg-opacity-20 flex rounded-2xl flex-col  text-white">
               <p class="text-[1.5rem] ml-[30px] mt-[30px]"># 1</p>
               <h2 class="text-[2.5rem] font-bold tracking-wider ml-[30px]">Kainchi</h2>
           </div>
       </div>
   ...
   <div class="bg-white rounded-lg shadow-lg overflow-hidden">
       ...
       <div class="relative h-56 w-[96%] mx-auto mt-[5px] rounded-2xl bg-cover bg-center" style="background-image: url('https://plus.unsplash.com/premium_photo-1669749358726-73d0d9da55e9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGslMjAlMjBsZXR0ZXIlMjBXYWxscGFwZXJ8ZW58MHx8MHx8fDA%3D');">
           <div class="absolute inset-0 bg-black bg-opacity-20 flex rounded-2xl flex-col  text-white">
               <p class="text-[1.5rem] ml-[30px] mt-[30px]"># 1</p>
               <h2 class="text-[2.5rem] font-bold tracking-wider ml-[30px]">Advanced</h2>
           </div>
       </div>
...
<div class="absolute inset-0 bg-cover bg-center"
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-[#3E2CA3] to-transparent opacity-100"></div>
</div>
        ...
        <div class="grid lg:col-span-8 w-full  sm:grid-cols-2 lg:grid-cols-3 gap-3 xl:gap-6">
            ...
            <div class="border-2 border-[#3E2CA3] p-6 rounded-xl bg-white shadow-lg flex flex-col justify-between">
                ...
                <p class="text-gray-600 mb-6 text-[12px]">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque vitae velit ex.  elit. Pellentesque vitae velit ex. ipsum dolor sit amet
                </p>
