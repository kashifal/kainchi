<template lang="">
   ...
   <div class="flex flex-col jsutify-center items-center gap-3">
    <div class="bg-white/90 p-8 rounded-2xl shadow-lg w-[90%] max-w-md text-center relative">
        ...
        <form>
            <input type="email" placeholder="Enter your email" class="w-full p-2 border-b-2 border-gray-300 bg-transparent focus:outline-none focus:border-indigo-500 mb-6" />
