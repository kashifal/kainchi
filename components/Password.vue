<template lang="">
   ...
   <div class="flex flex-col jsutify-center items-center gap-3">
        ...
        <form>
            <input type="email" placeholder="Enter your email" class="w-full bg-transparent  p-2 border-b-2 border-gray-300 focus:outline-none focus:border-indigo-500 mb-6" />
