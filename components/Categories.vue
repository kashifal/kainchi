<template lang="">
  ...
  <main class="flex-1">
    <h1 class="text-2xl xl:text-[36px] mr-7 mb-5 xl:mb-0 font-semibold">Categories</h1>
        ...
        <div class="md:p-5 md:px-10 py-10 px-4 mt-8 bg-white rounded-xl md:rounded-3xl shadow">
            ...
            <div class="flex flex-col-reverse  pb-10  gap-3 pt-5 text-[#212121] md:gap-20 md:flex-row-reverse">
                ...
                <div class="flex-1">
                    <form>
                        <h2 class="text-lg xl:text-[26px] font-semibold">Categories and subcategories</h2>
                      <div class=" mt-10">
                        <h4 class="text-sm text-[#656565]">What woud you creat ?</h4>
                        <div class="flex items-center mt-8 gap-8 flex-wrap">
                          <div class="flex itemsc-enter gap-3">
<label class="relative inline-flex items-center cursor-pointer">
  <input type="checkbox" checked value="" class="sr-only peer">
  <div class="group peer ring-0 bg-[#FBFBFB] rounded-full outline-none duration-300 after:duration-300 w-[39px] h-[21px] shadow-md peer-checked:bg-[#A988F5] peer-focus:outline-none after:content-[''] after:rounded-full after:absolute after:bg-[#3A0CA3]  after:outline-none after:h-[17px] after:w-[17px] after:top-[2px] after:left-[2px] after:-rotate-180 after:flex after:justify-center after:items-center after:text-[10px] peer-checked:after:translate-x-[18px] peer-checked:after:content-[''] peer-hover:after:scale-95 peer-checked:after:rotate-0 peer-checked:bg-[#A988F5]">
  </div>
</label>
                            <h5 class="text-[#656565] text-sm">Categorie</h5>
                          </div>
                          <div class="flex itemsc-enter gap-3">
<label class="relative inline-flex items-center cursor-pointer">
  ...
  <div class="group peer ring-0 bg-[#FBFBFB] rounded-full outline-none duration-300 after:duration-300 w-[39px] h-[21px] shadow-md peer-checked:bg-[#A988F5] peer-focus:outline-none after:content-[''] after:rounded-full after:absolute after:bg-[#3A0CA3]  after:outline-none after:h-[17px] after:w-[17px] after:top-[2px] after:left-[2px] after:-rotate-180 after:flex after:justify-center after:items-center after:text-[10px] peer-checked:after:translate-x-[18px] peer-checked:after:content-[''] peer-hover:after:scale-95 peer-checked:after:rotate-0 peer-checked:bg-[#A988F5]">
                            ...
                            <h5 class="text-[#656565] text-sm">Subcategorie</h5>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="space-y-4 mt-10">
                            <div>
                                <label
                                    class="block  font-semibold text-[#656565] text-[14px] tracking-wider">Name</label>
                                <input type="text"
                            ...
                            <div>
                                <label
                                    class="block  font-semibold text-[#656565] text-[14px] tracking-wider">Keywords</label>
                                <input type="text"
                                    class="w-full px-4 py-4 bg-[#DBDBDB] shadow-[0px_0px_6px_#0000001A] mt-2 blur-[8px] brightness-[-5px] border rounded-md border-[#DBDBDB]  mt-[6px]">
                            ...
                            <div class="flex items-start flex-wrpa gap-4">
                              <span class="bg-[#A988F5] rounded-full px-5 py-[3px] text-white text-sm">Note</span>
                              <p class="text-sm text-[#656565]">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt</p>
                            </div>
                        </div>
                        <button type="submit "
                            class="mt-6 bg-[#3A0CA3] text-white px-6 py-3.5 rounded-full hover:bg-[#3A0CA3] w-[100%]">Create</button>
                    </form>
                </div>
