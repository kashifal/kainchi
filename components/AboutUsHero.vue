<template lang="">
     <div class="px-4 mx-auto max-w-7xl">
        <div class="text-center">
            ...
            <p class="mt-[10px] text-[12px]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati eveniet
                sequi </p>
        </div>

        <!-- Adjust margin to 20px for the image section -->
                ...
                <div class="px-6 pt-5 pb-20 mx-auto max-w-7xl sm:pt-5 lg:px-8 lg:pt-5">
                    <div class="max-w-2xl mx-auto gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        ...
                        <div class="flex justify-center gap-8 mt-5 jd lg:mt-0 lg:pl-0">
                            ...
                            <div class="ml-[100px] w-44 flex-none space-y-4 sm:mr-0 sm:pt-20 lg:pt-16">
                                <div class="relative">
                                    <img src="https://images.unsplash.com/photo-1485217988980-11786ced9454?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&h=528&q=80"
                                        alt=""
                            ...
                            <div
                                ...
                                <div>
                                    <h2 class="font-extrabold text-[#3E2CA3]">Kain'chi</h2>
                                    <p class="text-[11px] tracking-wider">Lorem, ipsum dolor sit amet consectetur
                                        adipisicing elit.
                                        nostrum vero necessitatibus</p>
                                </div>
                    ...
                    <div class="flex justify-between mt-[20px] md:w-[55%] justify-right ml-auto relative ">

                        <div
                            class="bg-[#3E2CA3] whitespace-nowrap mt-40 md:mt-20 text-[white] font-bold flex items-center gap-3 cursor-pointer rounded-full justify-center py-[2px] px-5 h-[40px]">
                            <p class="text-[12px]  ">SCROLL DOWN</p>
                        ...
                        <div class="flex gap-2 ">
                          <div class="size-[50px] rounded-full flex items-center justify-center cursor-pointer hover:bg-[#212121] hover:text-white border border-[#212121] ">
                          ...
                          <div class="size-[50px] rotate-180 rounded-full flex items-center justify-center cursor-pointer hover:bg-[#212121] hover:text-white border border-[#212121] ">
                            <svg class="size-8" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M10.733 19.79a.75.75 0 0 0 1.034-1.086L5.516 12.75H20.25a.75.75 0 0 0 0-1.5H5.516l6.251-5.955a.75.75 0 0 0-1.034-1.086l-7.42 7.067a1 1 0 0 0-.3.58a.8.8 0 0 0 .001.289a1 1 0 0 0 .3.579z"/></svg>
                          </div>
                        </div>
                    </div>
